...
public class HibernateConfiguration {
    ...
    public LocalSessionFactoryBean sessionFactory(){
        ...
        sessionFactory.setPackagesToScan(new String[] {"com.springapp.mvc.database"});
    ...
    private Properties hibernateProperties(){
        ...
        properties.put("hibernate.hbm2ddl.auto", environment.getRequiredProperty("jdbc.hbm2ddl.auto"));
        return properties;
    }
